	...
	<div class="limiter">
		...
		<article>
			...
			<div class="contenuto">
				...
				<p>
					Mi ritengo un grande appassionato di tecnologie informatiche e soprattutto mi interesso molto alla progettazione, sviluppo e gestione dei siti web.
				</p>
				<p>
					Sono nel campo da molti anni in qualità di autodidatta e ho seguito molti progetti online per puro interesse e studio personale. 
				</p>
			</div>
		</article>
		...
		<article>
			...
			<div class="contenuto">	
				<h1>Competenze Tecniche e Pratiche </h1>
			 	...
			 	<p>
			 		In particolare, sono stato impiegato in alcune community di giochi MMORPG con il ruolo di game designer, tester e sviluppatore, grazie
			 		alle quali ho avuto modo di costruire e affinare l'uso e le funzioni del codice e della programmazione. 
			 	</p>
			 	<p>
			...
			<div class="contenuto">	
				...
				<p>
			 	...
			 	<p>
			 		...
			 		Liceo delle Scienze Umane / San Donà di Piave (VE)
			 	</p>
			 	<p>
			 		<strong>2011</strong> <br>
			 		<span>Diploma di Scuola Secondaria di Primo Grado (Scuola Media)</span> <br>
